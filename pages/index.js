            ...
            >
              <div className="flex flex-col w-full h-screen gap-8 items-center px-8 rounded-lg ">
                ...
                <span className="text-gray-color-lighter text-xl">
                  ...
                  necesites hasta que encuentres un mejor empleo. Nuestras
                  empresas asumen el coste de tu formación una vez te contraten.
                  Puedes formarte durante 12 meses en remoto a tu ritmo.
                </span>
